...
const Setting = () => {
  ...
  return (
    <PageContainer>
      ...
      <SettingBtn onClick={() => navigate("/drug/register")}>약 등록</SettingBtn> 
      <SettingBtn onClick={() => navigate("/drug/search")}>약 검색</SettingBtn> 
      <SettingBtn onClick={() => navigate("/drug/information")}>약 상세정보</SettingBtn>
